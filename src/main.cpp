...
int main()
{
    ...
    while (!WindowShouldClose())
    {
        ...
        {
            velocity -= slowdowGravityAfterFallFromJump;
        }
        ...
        {
            playerheightBeforeJump = playerPos.y;
            inJump = true;
        ...
        if (timerSlowDown >= slowdownDuration)
    {
        ...
        std::string fullText = "Print  : " + overlapStatus + " jump = " + JumpStatus;
